...
public class HandleProcess {
    ...
    public void run(final FileInfoFacade infoFacade) {
        try {
            ...
            messengerService.sendReport(infoFacade.getUserId(), infoFacade.getFileInfoId(), transactions.size(), saved.size());
            ...
            messengerService.sendReport(infoFacade.getUserId(), infoFacade.getFileInfoId(), ex.getMessage());
        }
    }
